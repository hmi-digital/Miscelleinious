...
class faqModel:
 ...
 def train(self):
  ...
  stopListFile=os.path.join(scriptDir,'data','dictionary','stopwords_hi.txt')
  arrayWords=[]
  stopWords=[]
  ...
  tfidfVec=TfidfVectorizer(corpus,decode_error='ignore',stop_words=stops,ngram_range=(1,5),tokenizer=m.stemTokenize)
